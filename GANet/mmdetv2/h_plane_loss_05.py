...
loss_weights = dict(center=0,
                    point=1.0,
                    error=1.0,
                    offset=0.05,
                    aux=0                    # 原设置:default: 0.2
                )                            # check
...
train_pipeline = [
    ...
    dict(
        ...
        keys=['img', 'gt_kpts_hm', 'int_offset', 'hyper_plane','offset_mask_weight','offset_mask'],
        meta_keys=[
...
log_level = 'INFO'
# work_dir = './work_dirs/culane/no_dcn'
work_dir = '../work_dirs/culane/hyper_planeloss05'
load_from = None
resume_from = None
...
fine_tune = dict(
    ...
    head_names = ['keypts_head', 'offset_head','reg_head'],
    max_epochs = 54,
    workflows=dict(    # 都用双数
        keypts_head=[('train',6), ('test', 1),  ('train', 6)
                     , ('test', 1), ('train', 6), ('test', 1)],
        offset_head=[('train', 6), ('test', 1), ('train', 6)
                     , ('test', 1), ('train', 6), ('test', 1)],
        reg_head=[('train', 6), ('test', 1), ('train', 6)
                     , ('test', 1), ('train', 6), ('test', 1)]
    )
)
