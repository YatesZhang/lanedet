...
log_level = 'INFO'
work_dir = './work_dirs/culane/baseline16'
load_from = None
resume_from = None
workflow = [('train', 5), ('test', 1), ('train', 5), ('test', 1), ('train', 5),
            ('test', 1), ('train', 5), ('test', 1), ('train', 5), ('test', 1),
            ('train', 5), ('test', 1), ('train', 5), ('test', 1), ('train', 5),
            ('test', 1), ('train', 5), ('test', 1), ('train', 5), ('test', 1),
            ('train', 5), ('test', 1), ('train', 4), ('test', 1), ('train', 1),
            ('test', 1)]
...
fine_tune = dict(
    ...
    workflows=dict(
        keypts_head=[('train', 5), ('test', 1), ('train', 5)
                     , ('test', 1), ('train', 5), ('test', 1)],
        offset_head=[('train', 5), ('test', 1), ('train', 5)
                     , ('test', 1), ('train', 5), ('test', 1)],
        reg_head=[('train', 5), ('test', 1), ('train', 5)
                     , ('test', 1), ('train', 5), ('test', 1)]
    )
)
