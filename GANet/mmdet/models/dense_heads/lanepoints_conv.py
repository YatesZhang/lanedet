...
class LanePointsConv(nn.Module):
    ...
    def forward_single(self, x):
        ...
        dcn_base_offset = self.dcn_base_offset.type_as(x)    # shape: [1, 14, 1, 1]
        ...
        # reppoints_pts_init_conv: conv3x3(256, 64)
        # reppoints_pts_init_out: conv1x1(64, 14)
        pts_out_init = self.reppoints_pts_init_out(
            self.relu(self.reppoints_pts_init_conv(pts_feat)))

        # regress from center
        # get kernel position from center points_init = 0
