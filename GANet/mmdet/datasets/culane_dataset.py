...
class CulaneDataset(CustomDataset):
    ...
    def load_labels(self, idx, offset_x, offset_y):
        ...
        shapes = []
        # string sequence to 2D float list:
        ...
        id_classes = [1 for i in range(len(shapes))]            # instance mask: e.g. [1,1,1,1]
        id_instances = [i + 1 for i in range(len(shapes))]      # instace id: e.g. [1, 2, 3, 4]
